...
const sectionsData = [
  ...
  },
  {
    ...
    type: 'tags',
    content: [
      'AWS', 'Kubernetes', 'Java', 'Ajax', 'Linux', 'Spring Boot', 'Docker',
      'MariaDB', 'Redis', 'NCP', 'GitHub', 'Spring Data JPA', 'RDBMS',
      'MongoDB', 'NoSQL', 'Git', 'MySQL',
    ],
  },
  {
    title: '포트폴리오',
    ...
    content: [
      {
        ...
        team: '1명',
        description: 'R언어에 대해 공부하고 직접 코딩해 볼 수 있는 웹서비스를 클라우드 인프라에서 구현. R언어 프레임워크인 샤이니를 사용해 만든 서비스를 직접 서버에 올려 다른 사용자가 확인할 수 있게 함.',
      ...
      },
      {
        ...
        team: '4명',
        description: '반려동물을 키우는 사람들을 위한 커뮤니티와 쇼핑몰 등 개발. Spring Boot와 React를 주 언어로 jwt토큰 기반 로그인, 공공 API 활용, 메일 및 지도 서비스를 구현.',
    ...
    content: [
      ...
      },
      {
        ...
        description: [
          ...
          '3번의 프로젝트를 통해 RESTful API, DB 설계, 클라우드 배포 경험.'
        ]
      },
      {
        title: '한국정보교육원 - 클라우드 컴퓨팅과 보안 솔루션 양성과정 수료',
